...
function loadMakesAndMissesTwo(playerData) {
    ...
    var data = [
        { name: "2PT MISSES", value: numberofMisses },
        { name: "2PT MAKES", value: numberOfMakes }
    ]
...
function loadMakesAndMissesThree(playerData) {
    ...
    var data = [
        { name: "3PT MISSES", value: numberofMisses },
        { name: "3PT MAKES", value: numberOfMakes }
    ]
